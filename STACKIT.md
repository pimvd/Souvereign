...
> **Note:** the STACKIT certificate carries no reference number or online verification URL — the PDF above is the certificate as issued. Scaleway certifications are listed separately in [Scaleway-Landingzone.md](Scaleway-Landingzone.md#scaleway-certifications).

---

## 1. Purpose and scope

_To be written._ This document is intended as the STACKIT counterpart to the [Scaleway landing zone design](Scaleway-Landingzone.md): the environment model, address plan, identity and segregation-of-duties model, traffic flows, capacity and availability assumptions, and the delivery (IaC) model for a STACKIT estate.
