...
*Companion to `Scaleway-Landingzone.md` (Draft v0.5). Keep this plan's phase Definitions of Done aligned with the validation suite (§15); if a phase can't be proven by the suite, the suite is missing a check.*
